...
import { Search, AlertTriangle, TrendingUp, TrendingDown, Filter, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="page-container">
      ...
      <p style={{ color: 'var(--text-muted)', marginBottom: '24px', fontSize: '14px' }}>
        A granular, itemized breakdown of every product sold, exact margins, and data anomalies.
      </p>
